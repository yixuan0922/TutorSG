              ...
              <TabsContent value="tutor">
                <Form {...tutorForm}>
                  <form onSubmit={tutorForm.handleSubmit(onTutorSubmit)} className="space-y-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="email" placeholder="tutor@example.com" {...field} data-testid="input-tutor-email" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="password" {...field} data-testid="input-tutor-password" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    >
                      {tutorLoginMutation.isPending ? "Logging in..." : "Login as Tutor"}
                    </Button>
                  </form>
                </Form>
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-muted-foreground">
                    ...
                    <Link href="/register" className="text-primary hover:underline" data-testid="link-register-tutor">
                      Register as Tutor
                    </Link>
                  </p>
                </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input type="email" placeholder="admin@tutorsg.com" {...field} data-testid="input-admin-email" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
