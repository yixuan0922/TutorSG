...
import type { Tutor, UpdateTutor } from "@shared/schema";
import { updateTutorSchema } from "@shared/schema";
...
import { User, Lock, Bell, Plus, X, Save } from "lucide-react";
...
export default function Settings() {
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: UpdateTutor) => {
      return await apiRequest("PATCH", `/api/tutors/${tutorId}`, data);
    },
    onSuccess: () => {
