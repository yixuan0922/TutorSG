    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[500px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/Tutor_teaching_student_professionally_bc0a54d9.png"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
            Connect with experienced tutors across all subjects and levels. Start
            your tutoring journey today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/jobs" data-testid="link-browse-jobs">
              <Button
                size="lg"
                variant="outline"
                className="bg-background/20 backdrop-blur border-white text-white hover:bg-background/30 min-w-[200px]"
              >
                Browse Tuition Jobs
              </Button>
            </Link>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Register as a tutor and complete your comprehensive profile with
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Explore available tuition assignments that match your expertise
                  and preferences.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Submit your application and start teaching once approved by
                  parents and admins.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Find tutors for all major subjects across primary to university
              levels
            </p>
          </div>
            ...
            {[
              ...
              >
                <CardContent className="p-6 text-center">
                  <subject.icon
                    className={`h-8 w-8 ${subject.color} mx-auto mb-3`}
                  />
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Join hundreds of tutors making a difference in students&apos; lives
            across Singapore.
          </p>
          <Link href="/register">
